...
describe('NewEmployeeForm component', () => {
    ...
    afterEach(() => {
        ...
        FormActions.addNewItem.mockReset();
    });
    ...
    test('should add new item', () => {
        ...
        expect(FormActions.addNewItem.mock.calls.length).toEqual(0);

        submitFormCallback({ name });

        expect(FormActions.addNewItem.mock.calls.length).toEqual(1);
        expect(FormActions.addNewItem).toHaveBeenCalledWith({
            name,
            id: 1,
